<button type="button" class="btn btn-info" data-myname="<?= $row['name']; ?>" data-myimage="<?= $row['image']; ?>" data-mydescription="<?= $row['description']; ?>" data-myprice="<?= $row['price']; ?>" data-myplacescovered="<?= $row['places_covered']; ?>" data-myid="<?= $row['t_id']; ?>" data-toggle="modal" data-target="#viewTour">
    View More
</button>
